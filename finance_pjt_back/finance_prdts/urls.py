...
#    path('loan_list/<str:loan_code>/', views.loan_detail),
#    path('loan_list/<str:loan_code>/Option_list', views.loanOption_list),
#    path('loan_list/<str:loan_code>/Option_list/<int:loanOption_pk>/', views.loanOption_detail),
